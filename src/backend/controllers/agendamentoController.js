...
exports.criarAgendamento = async (req, res) => {
    ...
    if (!nome_cliente || !servico_id || !data_hora) {
        return res.status(400).json({ message: 'Nome, serviço e data/hora são obrigatórios.' });
    }
    ...
    try {
        ...
        res.status(500).json({ message: 'Erro interno ao tentar agendar.' });
    }
};